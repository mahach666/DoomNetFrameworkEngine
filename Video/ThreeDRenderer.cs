...
namespace DoomNetFrameworkEngine.Video
{
    public sealed class ThreeDRenderer
    {
        ...
        private void DrawSolidWallRange(Seg seg, Angle rwAngle1, int x1, int x2)
        {
            ...
            var wallLights = scaleLight[DoomNetFrameworkEngine.DoomEntity.MathUtils.NetFunc.Clamp(wallLightLevel, 0, lightLevelCount - 1)];
            ...
            var planeLights = zLight[DoomNetFrameworkEngine.DoomEntity.MathUtils.NetFunc.Clamp(planeLightLevel, 0, lightLevelCount - 1)];
        ...
        private void DrawPassWallRange(Seg seg, Angle rwAngle1, int x1, int x2, bool drawAsSolidWall)
        {
            ...
            if (segTextured)
            {
                ...
                wallLights = scaleLight[DoomNetFrameworkEngine.DoomEntity.MathUtils.NetFunc.Clamp(wallLightLevel, 0, lightLevelCount - 1)];
            }
        ...
        private void AddSprites(Sector sector, int validCount)
        {
            ...
            var spriteLights = scaleLight[DoomNetFrameworkEngine.DoomEntity.MathUtils.NetFunc.Clamp(spriteLightLevel, 0, lightLevelCount - 1)];
